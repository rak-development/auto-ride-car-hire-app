...
const ModalComponent = ({
  ...
  <Modal show={showModal} onHide={onClose}>
    ...
    <Modal.Body>
      ...
      <ModalElement
        title='Date From'
        answer={format(formData.pickupDate, 'PPPppp')}
      />
      <ModalElement
        title='Drop-off Location'
        answer={formData.dropOffLocation}
      />
      <ModalElement
        title='Date To'
        answer={format(formData.dropOffDate, 'PPPppp')}
      />
      <ModalElement
      ...
      />
      <ModalElement
        title='I have discount code'
        answer={formData.hasDiscountCode ? 'Yes' : 'No'}
      />
