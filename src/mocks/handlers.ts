...
export const handlers = [
  http.get(
    'http://localhost:8000/assets/db/circle-content-data-en.json',
    () => {
  ...
  http.get(
    'http://localhost:8000/assets/db/circle-content-data-pl.json',
    () => {
      return HttpResponse.json({
  ...
  http.get('http://localhost:8000/assets/db/what-we-offer-data-en.json', () => {
    return HttpResponse.json([
      ...
      },
      {
        ...
        image:
          '/assets/images/what-we-offer/AutoRide-Worldwide-Transportation.jpg',
      },
      {
        id: 3,
        colSize: 6,
      ...
      },
      {
        ...
        title: 'Special Event',
        image:
          '/assets/images/what-we-offer/AutoRide-Special-Event-Limousine.jpg',
      },
    ])
  }),
